  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: "flex items-center gap-1 flex-nowrap",
        nav_button: cn(
        ...
        cell: "h-9 w-9 text-center text-sm p-0 relative [&:has([aria-selected].day-range-end)]:rounded-r-md [&:has([aria-selected].day-selected)]:rounded-md [&:has([aria-selected])]:bg-accent/50",
        day: cn(
